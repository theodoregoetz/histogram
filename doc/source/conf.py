...
# sphinx-quickstart on Thu Apr 30 12:06:19 2015.
#
...
# bitbucket
# new roles: bbissue, bbchangeset
#bitbucket_project_url = 'http://bitbucket.org/theodoregoetz/histogram'
...
latex_documents = [
  ('index', 'histogram.tex', 'histogram Documentation',
   'Johann T. Goetz', 'manual'),
]
...
man_pages = [
    ('index', 'histogram', 'histogram Documentation',
     ['Johann T. Goetz'], 1)
]
...
texinfo_documents = [
  ('index', 'histogram', 'histogram Documentation',
   'Johann T. Goetz', 'histogram', 'A histogram object for scientific data-reduction and statistical analysis.',
   'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'tables': ('https://pytables.github.io/', None),
    }
